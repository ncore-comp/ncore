const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxi8S5chZ76kD3aZt_Oiwq954IySlK2b7tfNA0VTxlHFGgY_BHMIovqbATtFdE-NzPe/exec";
const CLIENT_IP_URL = "https://api64.ipify.org?format=json";

    const initialAdmin = { users: [], requests: [] };
    const appData = { users: [], requests: [], holidays: {}, meta: { permissionsFromDb: false } };
    ...
    const db = {
        ...
        saveUsers: async () => {
            ...
            try {
                ...
                await response.json();
            } catch(e) { alert("유저 저장 오류"); } finally { document.getElementById('loading-overlay').style.display = 'none'; }
        }
    };
