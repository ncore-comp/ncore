                        ...
                        <table class="w-full min-w-[760px] text-sm">
                            ...
                            <tbody class="bg-white">
                                ${isAdminView
                                    ...
                                    `).join('') : `<tr><td colspan="4" class="px-4 py-10 text-center text-gray-400">${periodLabel} 보고 내역이 없습니다.</td></tr>`)
                            ...
                            <tbody class="bg-white">
                                ${rows.map((req) => `
                                    <tr class="border-t hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-3 text-gray-600 whitespace-pre-line">${security.cleanMultiline(req.note || '-')}</td>
                                    </tr>
                                `).join('')}
                            </tbody>
                        </table>
...
<button type="button" onclick="app.addSpecialLeaveTypeFromInput()" class="px-4 py-2.5 rounded-lg text-sm font-bold border border-indigo-200 text-indigo-600 hover:bg-indigo-50 shrink-0">추가</button>
        ...
        getModal: () => {
            ...
            <div id="report-detail-modal" class="fixed inset-0 bg-black/60 backdrop-blur-sm hidden justify-center items-center z-50 fade-in" onclick="if(event.target===this) app.closeReportDetail()">
                <div class="bg-white rounded-2xl p-6 w-full max-w-2xl shadow-2xl">
                    ...
                    <div id="report-detail-body" class="min-h-[180px]"></div>
