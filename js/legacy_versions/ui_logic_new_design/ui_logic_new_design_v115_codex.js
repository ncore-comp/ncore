                ...
                <div class="flex flex-col gap-4">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            ${isOverviewMode ? '' : `<button type="button" onclick="app.openWorkReportSettlementDraftModal()" class="px-4 py-2 rounded-lg border border-indigo-200 text-indigo-700 text-sm font-bold bg-indigo-50 hover:bg-indigo-100">메일 초안</button>`}
