    ...
    renderManagerDashboard: () => {
        ...
        if(allMembers.length > 0) {
            ...
            memberStatusHtml = departments.map(deptName => {
                ...
                const collapseButton = `<button onclick="app.toggleMobileMemberSection('${safeDept}')" class="flex items-center gap-2 text-left flex-1 min-w-0">
