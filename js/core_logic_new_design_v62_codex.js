const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwE4hvWbRW_fE9xCZ_o3AXLlOnxGRq2_xjKxwRfRwELI3uFVMf_2-FWGUb2x-ZQEtME/exec";
...
const SCRIPT_REQUEST_TIMEOUT_MS = 15000;
    ...
    const db = {
        ...
        load: async () => db.loadWithScope('all', { users: true, requests: true, boardPosts: true, holidays: true, specialLeaveTypes: true, userSpecialLeaves: true }),
        loadBoot: async () => db.loadWithScope('boot', { users: true, requests: false, boardPosts: false, holidays: true, specialLeaveTypes: true, userSpecialLeaves: true }),
        loadDeferred: async () => db.loadWithScope('rest', { users: false, requests: true, boardPosts: true, holidays: false, specialLeaveTypes: false, userSpecialLeaves: false }),
